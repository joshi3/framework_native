...
SurfaceFlinger::SurfaceFlinger()
    :   BnSurfaceComposer(),
        ...
        mDebugRegion(0),
        mDebugDDMS(0),
/* Vanzo:tanglei on: Sat, 21 Mar 2015 15:56:41 +0800
 */
#ifdef VANZO_FEATURE_DISABLE_HW_OVERLAYS
        mDebugDisableHWC(1),
#else
        mDebugDisableHWC(0),
#endif
...
/* Vanzo:wangfei on: Fri, 13 Mar 2015 20:09:11 +0800
 * port for 82m run HD
 */
#ifdef VANZO_MTK_SW_LCM_SUPPORT
							cur->setSkip(true);
#endif
